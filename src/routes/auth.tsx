    ...
    <PageTransition>
      <main className="relative min-h-screen bg-background text-foreground overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, color-mix(in oklab, var(--neon) 40%, transparent), transparent 70%)",
          }}
        />
        ...
        <div className="relative z-10 min-h-screen grid place-items-center px-4 py-16">
          <div className="w-full max-w-[440px] glass-dark rounded-[1.25rem] sm:rounded-[2rem] p-5 sm:p-8 md:p-10 shadow-2xl shadow-black/60 border border-white/5 animate-fade-in">
            ...
            {tab === "signin" ? (
              <form className="space-y-4 animate-fade-in" onSubmit={submit}>
                <Field
                  ...
                  error={errors.email}
                  valid={Boolean(form.email && !errors.email)}
                />
                <Field
                  icon={<Lock size={16} />}
                  ...
                  right={
                    <button
                      ...
                      className="text-foreground/50 hover:text-neon"
                    >
              ...
              <form className="space-y-4 animate-fade-in" onSubmit={submit}>
                <Field
                  ...
                  error={errors.name}
                  valid={Boolean(form.name && !errors.name)}
                />
                <Field
                  icon={<Mail size={16} />}
                  type="email"
            ...
            {authError && (
              <p className="mt-4 animate-fade-in text-center text-xs font-semibold text-red-500">
                {authError}
              </p>
            )}
            {successMessage && (
              <p className="mt-4 animate-fade-in text-center text-xs font-semibold text-emerald-400">
                {successMessage}
              </p>
            )}
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-full bg-white py-3 text-sm font-semibold text-black hover:bg-white/90 transition-colors disabled:cursor-not-allowed disabled:opacity-70"
            >
              {googleLoading ? (
  ...
  return (
    <div>
      <div className="relative">
        ...
        />
        {right ? (
          <span className="absolute right-4 top-1/2 -translate-y-1/2">{right}</span>
        ) : valid ? (
...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48">
      ...
      <path
        fill="#FF3D00"
        d="M6.3 14.7l6.6 4.8C14.7 16 19 12.5 24 12.5c2.9 0 5.6 1.1 7.6 2.9l5.7-5.7C33.7 6.4 29.1 4.5 24 4.5c-7.5 0-14 4.3-17.7 10.2z"
      />
      <path
        fill="#4CAF50"
        d="M24 43.5c5 0 9.6-1.9 13.1-5l-6-5.1c-2 1.4-4.4 2.1-7.1 2.1-5.3 0-9.7-3.1-11.3-7.5l-6.5 5C9.9 39.1 16.4 43.5 24 43.5z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.2 5.4l6 5.1C40.9 35.9 43.5 30.4 43.5 24c0-1.2-.1-2.3-.4-3.5z"
      />
    </svg>
  );
}
